...
class AdminRepository {
    ...
    public function selectByEmail($email) {
        ...
        $user = $stmt->fetch();
    return new User($user['id'], $user['nome'], $user['username'], $user['email'], $user['password'], $user['provincia'], $user['municipio'], $user['comuna'], $user['nacionalidade'], $user['morada'], $user['telemovel'], $user['perfil'], $user['estadoConta']);
    }
